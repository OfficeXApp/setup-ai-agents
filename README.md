# setup-ai-agents — OfficeX Skill

## Quick Install

```bash
npx skills add OfficeXApp/setup-ai-agents
```

> Or install on OfficeX: [officex.app/store/en/app/setup-ai-agents](https://officex.app/store/en/app/setup-ai-agents)

## About

This repository contains the skill documentation (SKILL.md) for the **setup-ai-agents** app on OfficeX.
